...
readonly SRC_DIR="./mastodon_finder"
readonly TMP_ROOT="/tmp"
readonly TMP_DIR="${TMP_ROOT}/mastodon_finder"
readonly OUTPUT_MD_BASENAME="mastodon_finder.flat.md"
...
# Run strip-docs for each subdirectory of tmp/mastodon_finder
